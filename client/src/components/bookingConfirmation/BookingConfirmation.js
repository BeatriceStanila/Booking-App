  ...
  return (
    ...
    >
      <div className="absolute lg:w-1/2 h-90 bg-navbar rounded-lg shadow-lg px-10 py-10 flex flex-col  justify-center items-center">
        <h1 className="text-2xl font-bold   font-poppins mb-10 text-title">
          Booking Completed 🖤
        </h1>
        <p className=" mb-4 font-sans text-lg text-body">
          Hi, {name} ! I am excited to see you on {date} at {time} for your{" "}
          {service} appointment.
        </p>
        <p className=" mb-8 font-sans text-lg text-body ">
        ...
        <p className="mb-3 text-lg font-sans font-semibold text-btn">
          Cosmina x
        </p>
        <button
          className=" px-6 py-2 font-semibold font-poppins tracking-widest text-white shadow-sm bg-btn rounded hover:bg-btnHover transition-color duration-200 delay-200"
          onClick={closeModal}
        >
          OK
        </button>
